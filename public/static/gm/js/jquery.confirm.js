...
(function ($) {
	...
	let jconfirm, Jconfirm;
	
    $.fn.confirm = function (options, title) {
    ...
    Jconfirm.prototype = {
        ...
        _watchContent: function () {
            ...
            this._timer = setInterval(function () {
                let now = that._hash(that.$content.html());
        ...
        _bindEvents: function () {
            ...
            this.$el.find('.jconfirm-box').click(function () {
                boxClicked = true;
            });
            ...
            if (this.keyboardEnabled) {
                setTimeout(function () {
                    $(window).on('keyup.' + that._rand, function (e) {
                        that.reactOnKey(e);
                    });
                }, 500);
            }
        ...
        _setButtons: function () {
            ...
            if (this.confirmButton && $.trim(this.confirmButton) !== '') {
				...
				if (!this.cancelButton) {
					let $confirmButton = this.$confirmButton;
					setTimeout(function(){$confirmButton.focus()}, 300);
				}
            }
        ...
        _getContent: function (string) {
            ...
            if (!this.content) { // if the content is falsy
                ...
                if (this.content.substr(0, 4).toLowerCase() === 'url:') {
                    ...
                    let url = this.content.substring(4, this.content.length);
        ...
        setDialogCenter: function () {
            ...
            if (this.$contentPane.css('display') !== 'none') {
                ...
                paneHeight = this.$contentPane.height();
                if (paneHeight === 0)
                    paneHeight = contentHeight;
            }
            let off = 100;
            let w = this.$content.outerWidth();

            //let s = '-clip-path: inset(0px 0px '+contentHeight+'px 0px);' +
            ...
            let boxHeight = this.$b.outerHeight() - paneHeight + contentHeight;
            let topMargin = (windowHeight - boxHeight) / 2;
            let minMargin = 100;
            let style;
        ...
        close: function () {
            ...
            let closeTimer = (this.closeAnimation === 'anim-none') ? 0 : this.animationSpeed;
            setTimeout(function () {
                that.$el.remove();
            }, closeTimer * 25 / 100);
        ...
        open: function () {
            ...
            let jcr = 'jconfirm-box' + this._rand;
    ...
    jconfirm.pluginDefaults = {
        ...
        watchInterval: 100,
        columnClass: 'col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-10',
        onOpen: function () {},
        onClose: function () {},
        onAction: function () {}
    };
